...
// Use environment variables from Netlify/production or fallback to correct Supabase values
...
// For production (Netlify), use environment variable. For development, use Supabase direct connection
const connectionString = process.env.NODE_ENV === 'production' 
  ? process.env.DATABASE_URL 
  : process.env.DATABASE_URL || `postgresql://postgres.dwrpznnbcqrmgoqdnqpo:${dbPassword}@aws-0-us-west-1.pooler.supabase.com:6543/postgres`;
