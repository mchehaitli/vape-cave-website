      ...
      >
        <div className="bg-gradient-to-b from-black to-gray-900 text-white min-h-screen">
          <div className="container mx-auto px-4 py-16 text-center">
            ...
            <p className="text-gray-400 mb-8">The blog post you're looking for could not be found.</p>
            <Button asChild>
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="text-center py-4">
                <p className="text-gray-400">Check back soon for more related content!</p>
              </div>
            </div>
          </div>
        </div>
