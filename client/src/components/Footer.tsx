      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <span className="text-white/70 hover:text-primary transition-colors cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/">
                  <span className="text-white/70 hover:text-primary transition-colors cursor-pointer">Home</span>
                </Link>
              </li>
              <li>
                <Link href="/products">
                  <span className="text-white/70 hover:text-primary transition-colors cursor-pointer">Products</span>
                </Link>
              </li>
              <li>
                <Link href="/locations">
              ...
              <li>
                <Link href="/contact">
                  <span className="text-white/70 hover:text-primary transition-colors cursor-pointer">Contact</span>
                </Link>
              </li>
              <li>
            ...
            <form className="space-y-3" onSubmit={handleSubscribe}>
              <div>
                <input 
                  ...
                  className="w-full px-4 py-2 rounded-lg border-none focus:outline-none focus:ring-2 focus:ring-primary text-gray-800"
                  value={email}
              ...
              <button 
                type="submit" 
                className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-2 px-6 rounded-lg transition-colors shadow-md"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-white/10 mt-12 pt-6 text-center md:flex md:justify-between md:text-left">
          ...
          <div className="space-x-4">
            <span className="text-white/70 hover:text-primary transition-colors cursor-pointer">Privacy Policy</span>
            <span className="text-white/70 hover:text-primary transition-colors cursor-pointer">Terms of Service</span>
            <span className="text-white/70 hover:text-primary transition-colors cursor-pointer">Age Verification</span>
          </div>
        </div>
      </div>
    </footer>
